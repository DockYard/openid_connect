%HTTPoison.Response{
  ...
  body: %{
    "keys" => [
      ...
      %{
        ...
        "kty" => "RSA",
        "n" =>
          "wEMMJtj9yMQd8QS6Vnm538K5GN1Pr_I31_LUl9-OCYu-9_DrDvPGjViQK9kOiCjBfyqoAL-pBecn9-XXaS-C4xZTn1ZRw--GELabuo0u-U6r3TKj42xFDEP-_R5RpOGshoC95lrKiU5teuhn4fBM3XfR2GB0dVMcpzN3h4-0OMvBK__Zr9tkQCU_KzXTbNCjyA7ybtbr83NF9k3KjpTyOyY2S-qvFbY-AoqMhL9Rp8r2HBj_vrsr6RX6GeiSxxjbEzDFA2VIcSKbSHvbNBEeW2KjLXkz6QG2LjKz5XsYLp6kv_-k9lPQBy_V7Ci4ZkhAN-6j1S1Kcq58aLbp0wDNKQ",
        "use" => "sig",
        "x5c" => [
  ...
  headers: [
    ...
    {"x-ms-request-id", "66b44222-1ec7-41ae-ad80-b5ec809c1e00"},
    {"x-ms-ests-server", "2.1.14059.13 - WUS2 ProdSlices"},
    {"X-XSS-Protection", "0"},
    {"Set-Cookie",
     "fpc=AhXhm59ZPKxAuoDA0xJOTXw; expires=Mon, 12-Dec-2022 20:59:22 GMT; path=/; secure; HttpOnly; SameSite=None"},
    {"Set-Cookie",
